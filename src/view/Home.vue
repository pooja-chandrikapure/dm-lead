        ...
        <div
            ...
            <div class="flex justify-center mb-6">
                <div @click="redirectToTg"
                    ...
                    <img src="/Logo Dm.png" class="rounded-full" alt="">
                </div>
            </div>

            <!-- Title -->
            <h1 class="text-white text-[24px] font-bold text-center mb-2 leading-tight">
                DOLLAR MACHINE
            </h1>
            <p class="text-white text-[24px] font-bold text-center mb-4 leading-tight">
                🚨 TOURNAMENT IS LIVE 🚨
            </p>
            
            <!-- Sub Text -->
            <p class="text-white text-center font-bold text-sm mb-4 ">
                <!-- <span class="text-red-500">Note -</span> -->
                The Forex Trading Community Everyone Is Talking About 
            </p>
            <!-- What You Get -->
...
const redirectToTg = () => {
    ...
    let telegramLink = "https://t.me/+W6m1BpVqqMAxYjY1"  // default (original link)

    if (campaign === "camp1") {
        telegramLink = "https://t.me/+W6m1BpVqqMAxYjY1"
    } else if (campaign === "camp2") {
        telegramLink = "https://t.me/+ryZmjYFbf2NlZWZl"
    } else if (campaign === "camp3") {
        telegramLink = "https://t.me/+2ZrFowybKaRiNjZl"
    } else if (campaign === "camp4") {
        telegramLink = "https://t.me/+IXYnKyMgkcpmYjhl"
    }
...
.title-text:hover .shine-overlay {
    animation: shine 0.8s ease-in-out;
}

.title-text {
    position: relative;
    background: linear-gradient(45deg, #d8dee9, #ffff99);
    box-shadow: 0 4px 15px rgba(37, 99, 235, 0.3);
}
